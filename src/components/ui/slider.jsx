...
const Slider = React.forwardRef(({ className, color = "lamp-green", ...props }, ref) => (
  ...
  >
    <SliderPrimitive.Track
      className="relative h-2 w-full grow overflow-hidden rounded-full bg-slider-track"
    >
      <SliderPrimitive.Range className={cn(
        "absolute h-full",
        {
          "bg-lamp-green": color === "lamp-green",
          "bg-lamp-orange": color === "lamp-orange",
        }
      )} />
    </SliderPrimitive.Track>
